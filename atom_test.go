...
func TestAtom(t *testing.T) {
	...
	assert.Equal(t, atom.P(), "pkg")
	assert.Equal(t, atom.Pf(), "pkg")
	assert.Equal(t, atom.Pr(), "")
	assert.Equal(t, atom.Pv(), "")
	assert.Equal(t, atom.Pvr(), "")
	...
	assert.Equal(t, atom.P(), "pkg-1")
	assert.Equal(t, atom.Pf(), "pkg-1-r2")
	assert.Equal(t, atom.Pr(), "r2")
	assert.Equal(t, atom.Pv(), "1")
	assert.Equal(t, atom.Pvr(), "1-r2")
	assert.Equal(t, atom.Cpn(), "cat/pkg")
